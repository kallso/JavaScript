...
var UIController = (function() {
    ...
    var formatNumberOnlyInt = function(num, type) {
        var numSplit, int, dec;
    ...
    return {
        ...
        addListItem: function(obj, type) {
            ...
            if (type === 'inc') {
                ...
                html = '<div class="item clearfix" id="inc-%id%"> <input type="text" class="item__description" value=%description%><div class="right clearfix"><div style="float: left;">+ </div><input type="text" class="item__value" value=%value%><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-close-outline"></i></button></div></div></div>';
            } else if (type === 'exp') {
            ...
            newHtml = newHtml.replace('%value%', formatNumberOnlyInt(obj.value, type));
        ...
        getFormatNumberInt: function() {
            return formatNumberOnlyInt;
        }
    };
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    const formatOnlyNumber = UICtrl.getFormatNumberInt();
    ...
    var setupEventListeners = function() {
        ...
        document.addEventListener('keydown', function(event) {
            if ((event.keyCode === 13 || event.which === 13) && event.target.classList.value !== 'item__value') {
                ctrlAddItem();
            }
            
            if ((event.keyCode === 13 || event.which === 13) && event.target.classList.value === 'item__value') {
                console.log(event.target.value, typeof event.target.value);
                let newValue = formatOnlyNumber(event.target.value,'inc');
    ...
    var switchType = function() {
      let typeBtn = document.querySelector(DOM.inputType);
        ...
        /*if (document.activeElement.classList[0] !== "add__value") {
